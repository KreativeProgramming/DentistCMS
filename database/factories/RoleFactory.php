...
class RoleFactory extends Factory
{
    ...
    public function configure()
    {
        ...
        return $this->afterCreating(function (Role $role) {
            $role->permissions()->attach(Permission::firstOrCreate(['id' => 1],['slug' => 'view-pacient' ,'name' => 'View Pacient']));
            $role->permissions()->attach(Permission::firstOrCreate(['id' => 2],['slug' => 'create-pacient', 'name' => 'Create Pacient']));
            $role->permissions()->attach(Permission::firstOrCreate(['id' => 3],['slug' => 'edit-pacient' , 'name' => 'Edit Pacient']));
            $role->permissions()->attach(Permission::firstOrCreate(['id' => 4],['slug' => 'delete-pacient' , 'name' => 'Delete Pacient']));
