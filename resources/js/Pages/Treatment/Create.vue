                            ...
                            <div class="flex flex-wrap -mx-3 mb-6">
                                <div class="w-full px-3 mb-6">
                                    ...
                                    >
                                        ...
                                        <template #lists>
                                            <li
                                                @click="selectPacient(item)"
                                                v-for="item in pacientFinded"
                                                :key="item.id"
                                                id="listbox-item-0"
                                                role="option"
                                                ...
                                                <div class="flex items-center">
                                                    <svg
                                                        v-if="
                                                            item.gender == 'F'
                                                        "
                                                        class="flex-shrink-0 h-6 w-6 bg-white rounded-full object-cover"
                                                        xmlns="http://www.w3.org/2000/svg"
                                                        viewBox="0 0 256 512"
                                                    >
                                                        <path
                                                            style="fill: #374151; stroke-width: 0.683348"
    ...
    methods: {
        ...
        save: function(data) {
            if (this.$v.form.$invalid) {
                ...
                this.$inertia.post("/treatment", data);
            }
        },
        onsearchPacient(e) {
            if (e.target.value) {
                this.pacientFinded = this.pacients.filter(
                    el => el.name.indexOf(e.target.value) !== -1
                );
            } else {
                this.pacientFinded = this.pacients;
            }
        ...
        selectPacient(pacient) {
            ...
            this.selectedPacient =
                pacient.name + " (" + pacient.personal_number + ")";
