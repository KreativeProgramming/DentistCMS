  ...
  <app-layout>
    <div class="flex flex-wrap mt-4">
      ...
      <div class="flex flex-wrap items-center">
       ...
       <Link :href="route('treatment.create')" as="button" class="float-right w-full inline-flex justify-center rounded-md border border-transparent shadow-sm px-4 py-2 bg-green-600 text-base font-medium text-white hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500 sm:ml-3 sm:w-auto sm:text-sm">
              Krijo
          </Link>
      </div>
      ...
      <table class="items-center w-full bg-transparent border-collapse">
        ...
        <tbody>
          <tr v-for="treatment in treatments.data" :key="treatment.id">
            ...
            >
              <Link v-if="treatment.deleted_at === null" :href="route('treatment.edit',treatment.id)" as="button" class="float-right w-full inline-flex justify-center rounded-md border border-transparent shadow-sm px-4 py-2 bg-blue-600 text-base font-medium text-white hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 sm:ml-3 sm:w-auto sm:text-sm">
                Ndrysho
              </Link>
              <div v-else>
              <button 
